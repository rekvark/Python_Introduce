...
# Данные методы должны применяться только к клеткам и выполнять увеличение, уменьшение, умножение и целочисленное (с округлением до целого) деление клеток,
# соответственно.
#
...
class Cell:
    ...
    def __add__(self, other):
        return f'Размер одной большой клетки равен: {self.quantity + other.quantity}'

    def __sub__(self, other):
        sub = self.quantity - other.quantity
        return f'Новая клетка уменьшилась. Теперь в ней: {sub} ячеек' if sub > 0 else 'Клетки больше нет'
